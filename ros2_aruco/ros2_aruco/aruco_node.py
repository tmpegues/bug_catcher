...
class ArucoNode(rclpy.node.Node):
    ...
    def camera_info_callback(self, info_msg):
        ...
        # Broadcast the camera to the world:
    ...
    def update_markerframes(self, markers, num_markers):
        ...
        for i in range(num_markers):
            ...
            self.marker_broadcaster = TransformBroadcaster(self)
            ...
            self.marker_transform.child_frame_id = f'{markers.marker_ids[i]}'
            ...
            self.marker_broadcaster.sendTransform(self.marker_transform)
